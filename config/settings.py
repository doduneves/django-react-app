...
SEND_CONFIRMATION_MAIL = config('SEND_CONFIRMATION_MAIL')
CONFIRMATION_MAIL_SENDER = config('CONFIRMATION_MAIL_SENDER')
CONFIRMATION_MAIL_LIST = config('CONFIRMATION_MAIL_LIST')
